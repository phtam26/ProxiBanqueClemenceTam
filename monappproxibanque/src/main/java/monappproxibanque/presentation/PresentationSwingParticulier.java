...
public class PresentationSwingParticulier extends JFrame {
	...
	private JPanel panelemail3 = new JPanel();
	...
	private JTextField zonesaisieemail3 = new JTextField(10);
	...
	private JLabel email3 = new JLabel("Email");
	...
	valider2.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			ic.lireClientParticulier(zonesaisieid.getText());
	...
	valider3.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			String prenom;
			String email;
			id=(Integer.parseInt(zonesaisieid3.getText()));
			zonesaisieid3.setText("");
			nom=zonesaisienom3.getText();
			zonesaisienom3.setText("");
			prenom=zonesaisieprenom3.getText();
			zonesaisieprenom3.setText("");
			email=zonesaisieemail3.getText();
			zonesaisieemail3.setText("");
			
			ic.modifierClientParticulier(int,nom,prenom,email);
